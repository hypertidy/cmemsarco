...
cmems_catalog_data
#> # A tibble: 1,730 × 13
#>    product_id       dataset_version_id  timeChunked_url geoChunked_url ...
```
...
dsn <- cmems_catalog_data$timeChunked_gdals3[1]
#> 'ZARR:"/vsis3/mdl-arco-time-045/arco/..."'
```
